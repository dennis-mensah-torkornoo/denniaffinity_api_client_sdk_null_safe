...
class MODELdadb44 {
  ...
  static List<MODELdadb44?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(MODELdadb44.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <MODELdadb44>[];
  ...
  static Map<String, MODELdadb44?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = MODELdadb44.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of MODELdadb44-objects as value to a dart map
  static Map<String, List<MODELdadb44?>?> mapListFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) {
    final Map<String, List<MODELdadb44?>?> map = <String, List<MODELdadb44>?>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = MODELdadb44.listFromJson(
            value,
