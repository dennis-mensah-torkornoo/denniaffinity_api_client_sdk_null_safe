...
// tests for CustomerDocumentsResponse
void main() {
  // final instance = CustomerDocumentsResponse();

  group('test CustomerDocumentsResponse', () {
    // String documentUrl
    ...
    test('to test the property `documentSubType`', () async {
      // TODO
    });
    ...
    test('to test the property `secondaryDocumentUrl`', () async {
      // TODO
    });
