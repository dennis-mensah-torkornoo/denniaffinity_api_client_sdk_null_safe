...
// tests for SupervisorCustomerResponse
void main() {
  // final instance = SupervisorCustomerResponse();

  group('test SupervisorCustomerResponse', () {
    // String id
    ...
    test('to test the property `onboardingDate`', () async {
      // TODO
    });
