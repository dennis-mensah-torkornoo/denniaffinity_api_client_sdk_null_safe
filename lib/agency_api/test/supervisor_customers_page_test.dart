...
// tests for SupervisorCustomersPage
void main() {
  // final instance = SupervisorCustomersPage();

  group('test SupervisorCustomersPage', () {
    // int totalPages
    ...
    // List<SupervisorCustomerResponse> content (default value: const [])
