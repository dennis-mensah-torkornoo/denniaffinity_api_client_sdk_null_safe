...
/// tests for AgencyApi
void main() {
  final instance = AgencyApi();

  group('tests for AgencyApi', () {
    // Delete task endpoint
    //
    //Future<InfoResponse> deleteTasks(String id) async
    test('test deleteTasks', () async {
      // TODO
    });
    ...
    test('test getNetworkProviders', () async {
      // TODO
    });
    ...
    test('test postWithdrawals', () async {
      // TODO
    });
    ...
    test('test postWithdrawalsOtp', () async {
      // TODO
    });
