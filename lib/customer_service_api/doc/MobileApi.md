...
> MobileOnboardingResponse mobileCompleteOnboarding(id, UNKNOWN_PARAM_NAME)
...
final api_instance = MobileApi();
final id = id_example; // String | 
final UNKNOWN_PARAM_NAME = (); //  | 

try {
    final result = api_instance.mobileCompleteOnboarding(id, UNKNOWN_PARAM_NAME);
    print(result);
} catch (e) {
...
> InlineResponse2001 mobileVerifyGpsAddress(gpsAddress)
