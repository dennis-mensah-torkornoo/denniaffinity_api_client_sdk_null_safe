...
part 'model/business_account.dart';
part 'model/business_details_request.dart';
part 'model/business_director.dart';
part 'model/business_documents.dart';
part 'model/business_shareholder.dart';
part 'model/business_type_enum.dart';
part 'model/change_account_status_request.dart';
...
part 'model/director_position_enum.dart';
...
part 'model/non_profit_type_enum.dart';
part 'model/number_of_transactions_enum.dart';
part 'model/onboard_address.dart';
part 'model/onboard_error.dart';
part 'model/onboard_error_errors_inner.dart';
part 'model/onboard_identification.dart';
part 'model/onboard_response.dart';
...
part 'model/registration_type_enum.dart';
part 'model/shareholder_type_enum.dart';
part 'model/source_of_funds_enum.dart';
part 'model/store_business_directors_request.dart';
part 'model/store_business_shareholders_request.dart';
