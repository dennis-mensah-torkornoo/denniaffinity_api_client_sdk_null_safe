...
class EmploymentSectorEnum {
  ...
  static EmploymentSectorEnum? fromJson(dynamic value) => EmploymentSectorEnumTypeTransformer().decode(value);

  static List<EmploymentSectorEnum>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EmploymentSectorEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EmploymentSectorEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
class EmploymentSectorEnumTypeTransformer {
  ...
  EmploymentSectorEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
