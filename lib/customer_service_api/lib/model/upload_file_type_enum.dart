...
class UploadFileTypeEnum {
  ...
  static UploadFileTypeEnum? fromJson(dynamic value) =>
    UploadFileTypeEnumTypeTransformer().decode(value);

  static List<UploadFileTypeEnum?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(UploadFileTypeEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <UploadFileTypeEnum>[];
}
...
class UploadFileTypeEnumTypeTransformer {
  ...
  UploadFileTypeEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
