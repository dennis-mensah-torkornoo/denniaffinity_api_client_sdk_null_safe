...
class AgencyStoreEkycEmploymentDetailsRequest {
  /// Returns a new [AgencyStoreEkycEmploymentDetailsRequest] instance.
  AgencyStoreEkycEmploymentDetailsRequest({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AgencyStoreEkycEmploymentDetailsRequest &&
     other.status == status &&
     other.sector == sector &&
  ...
  /// Returns a new [AgencyStoreEkycEmploymentDetailsRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AgencyStoreEkycEmploymentDetailsRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AgencyStoreEkycEmploymentDetailsRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AgencyStoreEkycEmploymentDetailsRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return AgencyStoreEkycEmploymentDetailsRequest(
  ...
  static List<AgencyStoreEkycEmploymentDetailsRequest>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AgencyStoreEkycEmploymentDetailsRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AgencyStoreEkycEmploymentDetailsRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AgencyStoreEkycEmploymentDetailsRequest> mapFromJson(dynamic json) {
    final map = <String, AgencyStoreEkycEmploymentDetailsRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AgencyStoreEkycEmploymentDetailsRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AgencyStoreEkycEmploymentDetailsRequest-objects as value to a dart map
  static Map<String, List<AgencyStoreEkycEmploymentDetailsRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AgencyStoreEkycEmploymentDetailsRequest>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AgencyStoreEkycEmploymentDetailsRequest.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
