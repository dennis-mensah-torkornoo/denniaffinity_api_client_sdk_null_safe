...
class IdTypeEnum {
  ...
  static IdTypeEnum? fromJson(dynamic value) =>
    IdTypeEnumTypeTransformer().decode(value);

  static List<IdTypeEnum?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(IdTypeEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <IdTypeEnum>[];
}
...
class IdTypeEnumTypeTransformer {
  ...
  IdTypeEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
