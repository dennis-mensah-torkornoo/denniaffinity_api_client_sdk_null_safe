...
class EmploymentStatusEnum {
  ...
  static EmploymentStatusEnum? fromJson(dynamic value) =>
    EmploymentStatusEnumTypeTransformer().decode(value);

  static List<EmploymentStatusEnum?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(EmploymentStatusEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <EmploymentStatusEnum>[];
}
...
class EmploymentStatusEnumTypeTransformer {
  ...
  EmploymentStatusEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
