...
class NumberOfTransactionsEnum {
  ...
  static NumberOfTransactionsEnum? fromJson(dynamic value) =>
    NumberOfTransactionsEnumTypeTransformer().decode(value);

  static List<NumberOfTransactionsEnum?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(NumberOfTransactionsEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <NumberOfTransactionsEnum>[];
}
...
class NumberOfTransactionsEnumTypeTransformer {
  ...
  NumberOfTransactionsEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
