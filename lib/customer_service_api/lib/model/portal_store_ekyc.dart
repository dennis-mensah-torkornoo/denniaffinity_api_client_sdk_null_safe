...
class PortalStoreEkyc {
  ...
  static List<PortalStoreEkyc?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(PortalStoreEkyc.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <PortalStoreEkyc>[];
  ...
  static Map<String, PortalStoreEkyc?> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = PortalStoreEkyc.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of PortalStoreEkyc-objects as value to a dart map
  static Map<String, List<PortalStoreEkyc?>?> mapListFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) {
    final Map<String, List<PortalStoreEkyc?>?> map = <String, List<PortalStoreEkyc>?>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = PortalStoreEkyc.listFromJson(
            value,
...
class PortalStoreEkycSexEnum {
  ...
  static PortalStoreEkycSexEnum? fromJson(dynamic value) =>
    PortalStoreEkycSexEnumTypeTransformer().decode(value);

  static List<PortalStoreEkycSexEnum?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(PortalStoreEkycSexEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <PortalStoreEkycSexEnum>[];
}
...
class PortalStoreEkycSexEnumTypeTransformer {
  ...
  PortalStoreEkycSexEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
...
class PortalStoreEkycIdentificationTypeEnum {
  ...
  static PortalStoreEkycIdentificationTypeEnum? fromJson(dynamic value) =>
    PortalStoreEkycIdentificationTypeEnumTypeTransformer().decode(value);

  static List<PortalStoreEkycIdentificationTypeEnum?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(PortalStoreEkycIdentificationTypeEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <PortalStoreEkycIdentificationTypeEnum>[];
}
...
class PortalStoreEkycIdentificationTypeEnumTypeTransformer {
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  PortalStoreEkycIdentificationTypeEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
      switch (data.toString()) {
