...
class ProofOfResidenceTypeEnum {
  ...
  static ProofOfResidenceTypeEnum? fromJson(dynamic value) =>
    ProofOfResidenceTypeEnumTypeTransformer().decode(value);

  static List<ProofOfResidenceTypeEnum?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(ProofOfResidenceTypeEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <ProofOfResidenceTypeEnum>[];
}
...
class ProofOfResidenceTypeEnumTypeTransformer {
  ...
  ProofOfResidenceTypeEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
