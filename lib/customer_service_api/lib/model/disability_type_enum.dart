...
class DisabilityTypeEnum {
  ...
  static DisabilityTypeEnum? fromJson(dynamic value) =>
    DisabilityTypeEnumTypeTransformer().decode(value);

  static List<DisabilityTypeEnum?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(DisabilityTypeEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <DisabilityTypeEnum>[];
}
...
class DisabilityTypeEnumTypeTransformer {
  ...
  DisabilityTypeEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
