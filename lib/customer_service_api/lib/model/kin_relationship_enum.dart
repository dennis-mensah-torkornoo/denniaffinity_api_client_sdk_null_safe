...
class KinRelationshipEnum {
  ...
  static KinRelationshipEnum? fromJson(dynamic value) =>
    KinRelationshipEnumTypeTransformer().decode(value);

  static List<KinRelationshipEnum?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(KinRelationshipEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <KinRelationshipEnum>[];
}
...
class KinRelationshipEnumTypeTransformer {
  ...
  KinRelationshipEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
