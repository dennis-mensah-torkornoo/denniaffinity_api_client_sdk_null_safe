...
class MobileOnboardingStepEnum {
  ...
  static MobileOnboardingStepEnum? fromJson(dynamic value) => MobileOnboardingStepEnumTypeTransformer().decode(value);

  static List<MobileOnboardingStepEnum>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MobileOnboardingStepEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MobileOnboardingStepEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
class MobileOnboardingStepEnumTypeTransformer {
  ...
  MobileOnboardingStepEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
