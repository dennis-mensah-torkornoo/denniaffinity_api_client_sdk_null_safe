...
class SourceOfFundsEnum {
  ...
  static SourceOfFundsEnum? fromJson(dynamic value) =>
    SourceOfFundsEnumTypeTransformer().decode(value);

  static List<SourceOfFundsEnum?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(SourceOfFundsEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <SourceOfFundsEnum>[];
}
...
class SourceOfFundsEnumTypeTransformer {
  ...
  SourceOfFundsEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
