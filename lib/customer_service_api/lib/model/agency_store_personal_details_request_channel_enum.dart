...
class AgencyStorePersonalDetailsRequestChannelEnum {
  ...
  static AgencyStorePersonalDetailsRequestChannelEnum? fromJson(dynamic value) => AgencyStorePersonalDetailsRequestChannelEnumTypeTransformer().decode(value);

  static List<AgencyStorePersonalDetailsRequestChannelEnum>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AgencyStorePersonalDetailsRequestChannelEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AgencyStorePersonalDetailsRequestChannelEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
class AgencyStorePersonalDetailsRequestChannelEnumTypeTransformer {
  ...
  AgencyStorePersonalDetailsRequestChannelEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
