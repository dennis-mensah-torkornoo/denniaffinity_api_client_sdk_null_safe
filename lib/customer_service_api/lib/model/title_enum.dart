...
class TitleEnum {
  ...
  static TitleEnum? fromJson(dynamic value) =>
    TitleEnumTypeTransformer().decode(value);

  static List<TitleEnum?>? listFromJson(dynamic json, {bool? emptyIsNull, bool? growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(TitleEnum.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <TitleEnum>[];
}
...
class TitleEnumTypeTransformer {
  ...
  TitleEnum? decode(dynamic data, {bool? allowNull}) {
    if (data != null) {
